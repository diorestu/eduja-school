    ...
    <div class="mb-6 rounded-2xl border border-gray-200 p-5 lg:p-6 dark:border-gray-800">
        <div class="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
            <div class="flex w-full flex-col items-center gap-6 xl:flex-row">
                <div class="h-20 w-20 overflow-hidden rounded-full border border-gray-200 dark:border-gray-800 bg-brand-500/10 text-brand-500 flex items-center justify-center text-3xl font-bold font-mono">
                    ...
                    <div class="mt-7">
                        ...
                        <div class="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                            ...
                            <div class="col-span-2 lg:col-span-1">
                                ...
                                <input type="text" value="+62 812-3456-789" readonly
                                    class="dark:bg-dark-900 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-400 shadow-theme-xs dark:border-gray-700 dark:bg-gray-900 dark:text-white/30" />
                            </div>
                            ...
                            <div class="col-span-2">
                                ...
                                <input type="text" value="Staf Sekolah" readonly
                                    class="dark:bg-dark-900 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-400 shadow-theme-xs dark:border-gray-700 dark:bg-gray-900 dark:text-white/30" />
                            </div>
                            ...
                            <div class="col-span-2 lg:col-span-1">
                                ...
                                <input type="password" name="password" placeholder="Isi hanya jika ingin diubah"
                                    class="dark:bg-dark-900 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
                            </div>
