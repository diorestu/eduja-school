            ...
            <div>
                ...
                <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-medium text-gray-800 dark:text-white/90">10110</p>
                    </div>

                    <div>
                        <p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">TAX ID (NPWP)</p>
                        <p class="text-sm font-medium text-gray-800 dark:text-white/90">01.234.567.8-999.000</p>
                    </div>
                </div>
            </div>
